...
export default function App() {
  // Las fuentes son un recurso visual: mientras cargan, React Native usa la
  // fuente del sistema y luego actualiza la interfaz sin alterar ningún flujo.
  useFonts({ DMSans_500Medium, DMSans_600SemiBold, DMSerifDisplay_400Regular });
