  ...
  return (
    ...
    >
      <View style={styles.sectionRoot}>
        ...
        <View pointerEvents="box-none" style={styles.familyViewSelectorRail}>
          <View pointerEvents="auto">
            <FamilyViewSegmentedControl activeTab={activeTab} onChange={setActiveTab} />
          </View>
        </View>
      </View>
