...
const COLORS: Record<ScheduleColorKey, { fill: string; soft: string; label: string }> = {
  terracotta: { fill: colors.terracotta[500], soft: colors.brandSoft, label: 'Terracota' },
  sage: { fill: colors.terracotta[600], soft: colors.brandSoft, label: 'Terracota intensa' },
  blue: { fill: colors.terracotta[400], soft: colors.brandSoft, label: 'Terracota clara' },
  gold: { fill: colors.terracotta[300], soft: colors.brandSoft, label: 'Terracota suave' },
};
...
const styles = StyleSheet.create({
  screen: { gap: spacing[4], paddingBottom: spacing[5] }, header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, members: { gap: spacing[2], paddingRight: spacing[4] }, memberChip: { minHeight: 44, maxWidth: 124, paddingHorizontal: spacing[2], borderRadius: radius.pill, backgroundColor: colors.surface.soft, borderWidth: 0, flexDirection: 'row', alignItems: 'center', gap: spacing[2] }, memberChipActive: { backgroundColor: colors.terracotta[500], borderColor: 'transparent' }, avatar: { width: 28, height: 28, borderRadius: 14, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.background.base }, avatarActive: { backgroundColor: 'rgba(255,255,255,0.2)' }, privacyRow: { minHeight: 64, padding: spacing[3], borderRadius: radius.md, backgroundColor: colors.surface.soft, flexDirection: 'row', alignItems: 'center', gap: spacing[3] }, feedback: { flexDirection: 'row', alignItems: 'center', gap: spacing[2], padding: spacing[3], borderRadius: radius.md, backgroundColor: colors.success.soft }, state: { minHeight: 160, alignItems: 'center', justifyContent: 'center' }, empty: { marginTop: spacing[2] }, privateState: { minHeight: 176, padding: spacing[5], justifyContent: 'center', alignItems: 'center', gap: spacing[2], backgroundColor: colors.surface.soft, borderRadius: radius.lg }, timeline: { gap: spacing[2] }, block: { minHeight: 76, borderLeftWidth: 4, borderRadius: radius.md, padding: spacing[3], flexDirection: 'row', alignItems: 'center', gap: spacing[3] }, time: { width: 44, gap: spacing[1] }, form: { paddingBottom: spacing[5], gap: spacing[3] }, daySelector: { flexDirection: 'row', gap: spacing[2] }, formDay: { width: 44, height: 44, borderRadius: radius.pill, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface.soft }, formDaySelected: { backgroundColor: colors.terracotta[500] }, colors: { flexDirection: 'row', gap: spacing[3] }, colorDot: { width: 44, height: 44, borderRadius: radius.pill }, colorDotSelected: { borderWidth: 3, borderColor: colors.text.primary }, actions: { flexDirection: 'row', gap: spacing[3] },
});
