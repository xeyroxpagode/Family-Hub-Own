...
const styles = StyleSheet.create({
  ...
  day: { flex: 1, minWidth: 0, minHeight: 68, alignItems: 'center', justifyContent: 'center', gap: spacing[1], backgroundColor: colors.surface.soft, borderRadius: radius.md, borderWidth: 0, borderColor: 'transparent' },
  daySelected: { backgroundColor: colors.terracotta[500], borderColor: 'transparent' },
