...
const styles = StyleSheet.create({
  screen: { gap: spacing[4], paddingBottom: spacing[5] }, header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, agendaHeader: { paddingTop: spacing[1] }, loading: { minHeight: 180, alignItems: 'center', justifyContent: 'center' }, agenda: { gap: 0 }, eventCard: { minHeight: 82, paddingVertical: spacing[3], borderBottomWidth: 1, borderBottomColor: colors.border.subtle, backgroundColor: 'transparent', flexDirection: 'row', alignItems: 'center', gap: spacing[3] }, eventTime: { width: 58, gap: spacing[1] }, eventAccent: { width: 4, alignSelf: 'stretch', borderRadius: radius.pill, backgroundColor: colors.terracotta[500] },
});
