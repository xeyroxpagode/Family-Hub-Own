...
> = {
  ...
  secondary: {
    container: { backgroundColor: colors.brandSoft, borderColor: 'transparent' },
    textTone: 'brand',
  },
  ghost: {
  ...
  danger: {
    container: { backgroundColor: colors.danger.soft, borderColor: 'transparent' },
    textTone: 'danger',
  },
  glass: {
  ...
  icon: {
    container: { backgroundColor: colors.surface.soft, borderColor: 'transparent' },
    textTone: 'primary',
  },
};
