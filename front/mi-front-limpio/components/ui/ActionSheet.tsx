...
const styles = StyleSheet.create({
  ...
  backdropDismiss: { ...StyleSheet.absoluteFill, zIndex: 0 },
  modalSheet: { zIndex: 1, backgroundColor: colors.surface.elevated, borderTopLeftRadius: radius.xxl, borderTopRightRadius: radius.xxl, paddingHorizontal: spacing[5], paddingTop: spacing[3], ...shadows.sheet },
  ...
  inlineOverlay: { ...StyleSheet.absoluteFill, zIndex: 10, justifyContent: 'flex-end', backgroundColor: colors.background.base },
  ...
  actionRow: { minHeight: 56, paddingHorizontal: 0, borderBottomWidth: 1, borderBottomColor: colors.border.subtle, backgroundColor: 'transparent', flexDirection: 'row', alignItems: 'center', gap: spacing[2] }, actionRowValue: { maxWidth: '58%', textAlign: 'right' },
