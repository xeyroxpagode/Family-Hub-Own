...
function getRoleDisplay(role: string): { label: string; color: string; bg: string } {
  ...
  const mapping: Record<string, { label: string; color: string; bg: string }> = {
    ...
    adult: { label: 'Adulto', color: colors.terracotta[600], bg: colors.brandSoft },
    adolescent: { label: 'Adolescente', color: colors.terracotta[600], bg: colors.brandSoft },
    senior: { label: 'Adulto mayor', color: colors.terracotta[600], bg: colors.brandSoft },
    child: { label: 'Niño', color: colors.terracotta[600], bg: colors.brandSoft },
