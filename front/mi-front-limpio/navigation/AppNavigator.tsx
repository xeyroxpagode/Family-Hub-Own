...
const PrivateNavigator = () => {
  ...
  // Experience is a personal presentation preference. It is deliberately
  // evaluated only after authentication/household onboarding routing, never
  // from age, role or permissions.
  ...
  if (pendingJoinToken) {
    return (
      ...
      <PrivateStack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <PrivateStack.Screen name="SimpleShell" component={SimpleShell} />
  ...
  if (initialPrivateRoute === 'ExperienceShell' && !setupCompleted) {
    return <PlannerReliabilityRuntimeOwner ownerSurface="AppShellPrivate-ExperienceSelector"><ExperienceSelectorScreen /></PlannerReliabilityRuntimeOwner>;
  }
