...
export const ROUTE_NAMES = {
  ...
  PresetDetail: 'PlannerPresetDetail',
  PresetCreate: 'PlannerPresetCreate',
  PresetEdit: 'PlannerPresetEdit',
  DraftRecovery: 'PlannerDraftRecovery',
  DraftResume: 'PlannerDraftResume',
  PresetDraftsTrash: 'PlannerPresetDraftsTrash',
  Trash: 'PlannerTrash',
