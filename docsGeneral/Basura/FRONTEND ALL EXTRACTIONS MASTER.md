...
# **SOURCE 16 — API \+ TEST CASES \+ EDGE CASES**

## **Archivo recomendado**

`Api + Testcases + Edge cases v1.txt`

## **Tipo de documento**

API / test cases / edge cases
...
* endpoints reales;  
* errores que frontend debe mostrar;  
* edge cases;  
...
* planner;  
* members;  
* reglas que afectan forms y navegación.

## **Contenido extraído**

\[PEGAR AQUÍ EL CONTENIDO DE `Api + Testcases + Edge cases v1.txt`\]

---

# **SOURCE 17 — ESQUEMA DE BASE DE DATOS**
...
Base de datos / entidades / relaciones

## **Uso para frontend**

Extraer solo lo útil para frontend:

* entidades visibles;  
* roles;  
* estados;  
* relaciones household/person/member;  
* task status;  
* event status;  
* permisos;  
* campos que se muestran;  
* campos que NO debe mandar frontend;  
* reglas de ownership/active household.

No convertir esto en spec backend.

## **Contenido extraído**

\[PEGAR AQUÍ EL CONTENIDO DE `Esquema de base de datos v1.txt`\]
